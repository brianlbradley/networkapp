...
const	{firstname,lastname,phone,city,email,password,company,isChecked}=req.body
...
const	{location,restaurant,resdescription,attractions,attdescription}=req.body
